...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-white">Nuevo Estudiante</h1>
    ...
    <div style="background: rgba(0,0,0,0.5);" class="rounded-lg shadow p-6 max-w-lg border border-emerald-800">
        <form action="{{ route('estudiantes.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="apellido" value="{{ old('apellido') }}" class="w-full bg-gray-900 border border-emerald-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="codigo" value="{{ old('codigo') }}" class="w-full bg-gray-900 border border-emerald-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500">
